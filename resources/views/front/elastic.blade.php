...
<div class="card container mt-3">
  <div class="card-body">
    ...
    <a class="card-link" href="" style="color: blue;">Elasticsearch</a>
  </div>
</div>
...
<section id="faq" class="faq">
      <div class="container">
        ...
        <div class="section-title mt-5">
          <h2>Elasticsearch Questions</h2>
        </div>

        <div class="row  d-flex align-items-stretch" id="about">
        @foreach($elasticsearch as $data)
          <div class="col-lg-6 faq-item docket-content">
            ...
            <a href="elastic-details/{{$data->id}}"><p>{!! substr($data->content,0,200) !!}</p></a>
          </div>
          @endforeach
        </div>
      </div>
