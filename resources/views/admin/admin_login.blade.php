        ...
        <div class="auth-box bg-dark border-top border-secondary">
          <div id="loginform">
            <div class="text-center pt-3 pb-3">
              <span class="db"><img src="{!! asset('../newdash/assets/images/logo.png ') !!}" alt="logo"/></span>
            </div>
            <!-- Form -->
            <form class="form-horizontal mt-3" id="loginform" action="admin-login" method="post">
                @csrf
              <div class="row pb-4">
                <div class="col-12">
