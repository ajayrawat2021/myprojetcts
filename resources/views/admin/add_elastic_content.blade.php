...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Add Elasticsearch</h4>
...
<div class="card">
    <form class="form-horizontal" action="/addelastic" method="post">
        @csrf
        <div class="card-body">
            <h4 class="card-title"><a href="/show-elasticsearch-list"><button type="button" class="btn btn-primary">
                        Show List
                    </button></a></h4>
